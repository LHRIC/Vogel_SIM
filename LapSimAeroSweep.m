...
for iCoPG = 1:length(CoPRange)
    ...
    LapSimOutput = LapSim(LLTD, WBase, WDF, CG, L, twf, twr, rg_f, rg_r,pg, WRF, WRR, IA_staticf, IA_staticr, IA_compensationr, IA_compensationf, casterf, KPIf, casterr, KPIr, ClaSet, CdaSet, CoPCG, showPlots);
