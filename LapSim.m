...
radii = [10:5:120]; % range of turn radii at which sim will evaluate (ft)
...
% plot(cg,F_yCount,'r')
% figure(2)
% plot(cg,wfin1,'m',cg,wfout1,'c',cg, wrin1,'b',cg,wrout1,'g')
...
% lateralgScaled = lateralg*.8
% velocity_y = lateralgScaled.*32.2.*radii;
% velocity_y = sqrt(velocity_y);
velocity_y = lateralg.*32.2.*radii;
velocity_y = sqrt(velocity_y);
