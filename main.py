...
def main():
    ...
    # simulator.sweep(num_steps = 2, trackwidth_f=(45, 70), total_weight_f=(300, 450), xlabel = "Track Width", ylabel = "Weight")
    # simulator.sweep(num_steps = 30, xlabel="Final Drive", final_drive=(2, 5))
    simulator.sweep(num_steps=3, camber_gain_r=(-0.2, 0.1), static_camber_f=(-7, 4), xlabel="Camber Gain (deg/mm)", ylabel="Camber Angle")    
