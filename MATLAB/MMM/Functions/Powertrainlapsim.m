...
while rpm > shiftpoint
    ...
    rpm = initialV*gearTot/tire_radius*60/(2*pi);        % calculate engine speed based on new wheel speed [RPM]
end
...
Fx = torque/tire_radius;      % force on contact patch from drivetrain [N]
